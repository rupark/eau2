 ...
 */
class ColumnString : public ColumnIce {
public:
    String **values_;
    ColumnString() : ColumnIce() {
    ...
    char* get_char(size_t i) {
        ...
        size_t str_len = values_[i]->size_;
        char* ret = new char[str_len + 3];
        ret[0] = '"';
        for (size_t j = 0; j < str_len; j++) {
            ret[j + 1] = values_[i]->cstr_[j];
        }
        ret[str_len + 1] = '"';
        ret[str_len + 2] = '\0';
        return ret;
 ...
 *
 */
class ColumnFloat : public ColumnIce {
public:
    float **values_;
    ColumnFloat() : ColumnIce() {
...
class ColumnInt : public ColumnIce {
public:
    int **values_;
    ColumnInt() : ColumnIce() {
...
class ColumnBool : public ColumnIce {
public:
    bool **values_;
    ColumnBool() : ColumnIce() {
